...
//copy from https://github.com/mitchtabian/Google-Maps-Google-Places/blob/67054c45d34ffa5e0a0564fc8c61de939522a6c4/app/src/main/java/codingwithmitch
// /com/googlemapsgoogleplaces/MapActivity.java

public class accept_request extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void initMap(){
        ...
        mapFragment.getMapAsync(accept_request.this);
    }
                ...
                location.addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(accept_request.this, "unable to get current location", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (mLocationPermissionsGranted) {
            ...
            //request_accepted_map.getUiSettings().setMyLocationButtonEnabled(false);
